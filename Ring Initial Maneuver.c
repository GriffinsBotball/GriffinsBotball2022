...
int main()
{
    ...
    msleep(500);
    //pop dad dal ope dop  yip did ali pdi pip sni pid ali pid ipe
    ...
    // those darn glaciers keep gettin in the floor boards.
    
    
   B6(); //backing uop after squaring
   ...
   msleep(50);
    ...
    // insert roblox oof noise
	 
    printf(" Ghuoae    meat tastes good! "); //meat sack
